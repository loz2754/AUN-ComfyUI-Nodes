...
# Extracted and adapted from the ComfyUI_Fill-Nodes pack.
# Original author: filliptm (github.com/filliptm/ComfyUI_Fill-Nodes / Machinedelusions).
# Great node pack — the RIFE integration here is excellent.
...
class AUNRIFE:
    ...
    Downloads models to the ComfyUI models folder on first use.
    """
    ...
    def load_model(self, ckpt_name):
        ...
        try:
            ...
            from .aun_rife_arch import IFNet
