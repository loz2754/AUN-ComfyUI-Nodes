...
class AUNInputsRefineBasic:
    ...
    def inputs(self, ckpt_name, refine_ckpt, speed_lora, speed_lora_model, speed_lora_strength, clip_skip, sampler, scheduler, cfg, steps, width, height, aspect_ratio, aspect_mode, batch_size, seed):
