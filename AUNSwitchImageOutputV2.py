...
class AUNSwitchImageOutputV2:    
    ...
    def index_switch(self, no_upscale, latent_or_image_upscale, both_upscale, refined, index):
        options = [no_upscale, latent_or_image_upscale, both_upscale, refined]
        labels = ["no_upscale","latent_or_image_upscale", "both_upscale", "refined"]
...
NODE_DISPLAY_NAME_MAPPINGS = {
    "AUNSwitchImageOutputV2": "AUN Switch Image OutputV2",
}
