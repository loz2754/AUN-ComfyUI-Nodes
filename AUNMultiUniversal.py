...
class AUNMultiUniversal:
    ...
    def execute(self, mode="Bypass", slot_count=3, toggle_restriction="default", show_outputs=True, AllSwitch=False, control_mode="manual", Index=0, show_AllSwitch=False, unique_id=None, **kwargs):
        try:
